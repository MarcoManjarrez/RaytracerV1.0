...
/**
 * Triangle class, creates triangle objects.
 * @author Jafet Rodriguez
 */
public class Triangle implements IIntersectable {
    /**Stores the epsilon factor to give lee-way to intersections**/
    public static final double EPSILON = 0.0000000000001;
    /**Stores the triangle's vertices**/
    private Vector3D[] vertices;
    /**Stores the vertice's normals**/
    ...
    /** getNormal method, gets the normal of the triangle to assist on smooth shading
     * @author Jafet Rodriguez
     * **/
    ...
    /** getIntersection method, returns where the triangle was intersected with
     * @param ray ray that intersected with the triangle
     * @author Jafet Rodriguez
     *
     * **/
    @Override
